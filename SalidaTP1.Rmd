---
title: "Trabajo Práctico 1 - Parte 1 - (RMD+Git_v5)"
...
No obstante seguimos apreciando que teemos 24 filas con missing values

```{r Gráfico - VII}
index <- c(which.max(glx$BjMAG),which(is.na(glx$S280MAG)) )
# index
# typeof(index)
p5 <- qplot(BjMAG, S280MAG-BjMAG, data = glx[-index,])
p6 <- qplot(BbMAG, S280MAG-BbMAG, data = glx[-index,])
